                ...
                <div class="w-full px-4">
                    <div class="shadow-lg p-5 bg-white rounded-lg">
                        <div class="flex justify-between items-center mb-3">
                            <div class="flex-1">
                                <h4 class="text-black text-center font-bold text-2xl">View all request for Manager</h4>
                            </div>
                        </div>
                            ...
                            <table class="min-w-full pt-3 table-auto border-collapse " id="tableData">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="border border-gray-200 px-4 py-2">Current Role</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            async function loadData() {
                try {
                    const res = await axios.get('/api/get-all-managers-requests');
                                 ...
                                 <td class="border border-gray-200 px-4 py-2">
                                    ${
                                        user.manager_status === 'pending'
                                            ? `<button data-id="${user.id}" class="request-btn bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                                Accepted
                                               </button>`
                                            : 'Accepted'
                                    }

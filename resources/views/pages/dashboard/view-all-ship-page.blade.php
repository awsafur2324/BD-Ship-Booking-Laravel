            ...
            <div class="w-full px-4">
                <div class="shadow-lg p-5 bg-white rounded-lg">
                    <div class="flex justify-between items-center mb-3">
                        <div class="flex-1">
                            <h4 class="text-black text-center font-bold text-2xl">All Available Ships</h4>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full pt-3 table-auto border-collapse " id="tableData">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="border border-gray-200 px-4 py-2">Manager Name</th>
                                    <th class="border border-gray-200 px-4 py-2">Manager Phone</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            async function loadData() {
                try {
                    const res = await axios.get('/api/getAllShips');
                ...
                <tr>
                    ...
                    <td>${ship.couch_no}</td>
                    <td>${ship.ship_manager_name}</td>
                    <td>${ship.ship_manager_number}</td>
                    <td>
                        <button data-id="${ship.id}" class="deleteBtn px-4 py-2 text-sm text-white border bg-red-500 border-red-500 rounded-md hover:bg-red-600 ">
                            Delete
                        </button>
                    </td>
                </tr>

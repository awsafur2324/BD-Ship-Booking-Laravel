<div class="w-full h-screen flex items-center justify-center bg-gray-800">
    <div class="bg-gray-200 w-96 h-auto rounded-lg pt-8 pb-8 px-8 flex flex-col items-center">
        ...
        <input type="text" class="w-full h-12 rounded-lg px-4 text-base focus:ring-blue-600 mb-4"
        ...
        <p class="text-left mb-4 w-full text-black text-base ">If otp not sent then <a href=""
                class="text-blue-600">Click Here</a></p>
    </div>
</div>

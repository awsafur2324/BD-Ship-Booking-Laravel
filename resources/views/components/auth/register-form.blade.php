<div class="w-full h-screen flex items-center justify-center bg-gray-800">
    <div class="bg-gray-200 w-96 h-auto rounded-lg pt-8 pb-8 px-8 flex flex-col items-center">
        ...
        <div class="w-full text-left mb-4 flex justify-start items-center gap-2 text-black "><input type="checkbox"
                name="role" id="role" value="manager"><label for="role">Become a Manager</label></div>
...
<script>
    ...
    async function register() {
        ...
        const role = $('#role').is(':checked') ? 'manager' : 'user'; // Determine role dynamically

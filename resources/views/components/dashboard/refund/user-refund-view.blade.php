        ...
        <div class="w-full px-4">
            <div class="shadow-lg p-5 bg-white rounded-lg">
                <div class="flex justify-between items-center mb-3">
                    <div class="flex-1">
                        <h4 class="text-black text-center font-bold text-2xl">My Refund History</h4>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        async function loadData() {
            try {
                const res = await axios.get('/api/view-user-refund-requests');
                ...
                data.forEach((refundData, index) => {
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-200 px-4 py-2">${refundData.refund_status ?? 'Pending'}</td>
                    </tr>
                `;

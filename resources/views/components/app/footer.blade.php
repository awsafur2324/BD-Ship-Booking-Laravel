    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap text-left lg:text-left">
        <div class="w-full lg:w-6/12 px-4">
          <h4 class="text-3xl font-semibold text-gray-900">BD Ship Booking</h4>
          <h5 class="text-lg mt-0 mb-2 text-blueGray-600">
            A online platform to booking ship tickets. Find us on any of these platforms.
          </h5>
      ...
      <div class="flex flex-wrap items-center md:justify-between justify-center">
        <div class="w-full md:w-4/12 px-4 mx-auto text-center">
          <div class="text-sm text-blueGray-500 font-semibold py-1">
            Copyright © <span id="get-current-year">{{date('Y')}}</span><a href="#" class="text-blueGray-500 hover:text-gray-800" target="_blank"> BD Ship Booking </a> by
            <a href="#" class="text-blueGray-500 hover:text-blueGray-800">Shihab Hasan</a>.
          </div>
        </div>
      </div>
    </div>
